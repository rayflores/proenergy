...
<section id="section_pflx-bir-wrapper" class="showcase">
    <div class="container-fluid p-0">
        <div class="row g-0">
            <div class="col-lg-5 text-white order-lg-2 showcase-img" style="background-image: url('<?php echo esc_url(wp_get_attachment_url($bir_image_id)); ?>');">
