...
<section id="section_bulleted-image-right" class="" style="background-color: <?php echo $section_bg; ?>">
        ...
        <div class="container-fluid px-0 pt-5">
            ...
            <div class="row g-0">
                <div class="col-12 col-md-6 order-1 order-md-2 bir-text-container">
                ...
                <div class="col-1 order-2 d-md-none d-md-block"></div>
                <div class="col-12 col-md-5 order-md-1 order-md-3 bir-image reveal">
